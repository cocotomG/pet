...
.login-bg {
  background: url("@images/bgser.png") no-repeat;
...
<template>
  <div class="h-screen login-bg">
    <div class="login-container">
      <div class="ml-10 ">
        <img class="login-white" src="@images/logo-color-white.png" alt="logo">
      </div>
      <div class="flex items-center h-full pb-20">
        ...
        <div class="flex items-center justify-center flex-1">
          <a-card class="mr-6 overflow-auto" style="height: 560px;width: 520px;">
...
import { ProjectCode } from '@/utils/request'
...
async function checkToken() {
  let { code } = await authApi.checkToken()
...
function loginSuccess() {
  ...
  notification.success({
    message: '登录成功!',
    description: `欢迎回来，${userStore.user?.name}！`,
    duration: 2,
  })
